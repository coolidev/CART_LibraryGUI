  ...
  return (
    <div className={classes.root}>
      <Dialog
        ...
        style={{minWidth: (window.screen.availHeight / zoom) * 0.8, minHeight: (window.screen.availHeight / zoom) * 0.6}}
      ...
      >
        ...
        >
          <Grid
            ...
            spacing={3}
            style={{ marginTop: ((zoom<=1)?((window.screen.availHeight / zoom) * 0.02):0) }}
          >
